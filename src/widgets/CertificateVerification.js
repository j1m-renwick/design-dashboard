...
const states = [
    ...
    {
        instructionText: "Some other text",
        consoleText: "SIGNATURE_HEX=$(openssl x509 -in *.google.com.cer -inform DER -text -noout -certopt ca_default -certopt no_validity -certopt no_serial -certopt no_subject -certopt no_extensions -certopt no_signame | grep -v 'Signature Algorithm' | tr -d '[:space:]:')"
    }
]
...
export default function CertificateVerification() {
    ...
    return (
        <div style={{display: "flex", justifyContent: "center", flexDirection: "column", height: "100%"}}>
            ...
            <InstructionBox text={states[keyFrame].instructionText}>
            </InstructionBox>
            <LinuxConsole consoleText={states[keyFrame].consoleText}/>
        </div>
    );
}
